...
class SentrinaAlaminosUnitsList extends PropertyCard {
  constructor() {
    super();
    this.currentPage = this._getCurrentPage();
    this.limit = 6;
    this.totalItems = 0;
    this.category = "Sentrina Alaminos";
...
// Initialize the Sentrina Alaminos units list
new SentrinaAlaminosUnitsList();