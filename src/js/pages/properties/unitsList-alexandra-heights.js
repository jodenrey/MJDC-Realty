...
class AlexandraHeightsUnitsList extends PropertyCard {
  constructor() {
    super();
    this.currentPage = this._getCurrentPage();
    this.limit = 6;
    this.totalItems = 0;
    this.category = "Alexandra Heights";
...
// Initialize the Alexandra Heights units list
new AlexandraHeightsUnitsList();
